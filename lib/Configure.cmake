...
MACRO(CONCRETE_SET_CONFIG_FILE_PROPERTIES CONFIG_PREFIX)
    SET(CONCRETE_MARCO_PREFIX ${CONFIG_PREFIX})
...
MACRO(CONCRETE_CONFIG_OPTION_ENABLE)
    ...
    ENDIF()
ENDMACRO(CONCRETE_CONFIG_OPTION_ENABLE)

MACRO(CONCRETE_GEN_CONFIG_FILE DEST_PATH)
    IF (NOT ${CONCRETE_INIT_COMPLETED})
        MESSAGE(FATAL_ERROR "Library has not been initialized! please call concrete_init first!")
    ENDIF()
    CONFIGURE_FILE(
...
ENDMACRO(CONCRETE_GEN_CONFIG_FILE)
